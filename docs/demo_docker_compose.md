...
We will use Docker compose to start Zookeeper, Kafka and a cluster of 3 PranaDB nodes.
...
We now need to create the topics used in the demo.
...
Now we're going to start a Prana CLI.
...
```
make publish-payments num_messages=1000 index_start=0
