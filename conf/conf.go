...
type Config struct {
	...
	APITLSConfig                     tls.ServerTLSConfig `help:"API TLS configuration" embed:"" prefix:"api-tls-"`
...
func (c *Config) Validate() error { //nolint:gocyclo
	...
	if !reflect.DeepEqual(c.APITLSConfig, tls.ServerTLSConfig{}) {
		if err := c.APITLSConfig.Validate(); err != nil {
