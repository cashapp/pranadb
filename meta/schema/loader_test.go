...
func runServer(t *testing.T, clus cluster.Cluster, notif *remoting.FakeServer) (*meta.Controller, *command.Executor) {
	...
	notif.RegisterMessageHandler(remoting.ClusterMessageDDLStatement, ce, false)
	notif.RegisterMessageHandler(remoting.ClusterMessageCloseSession, pullEngine, false)
